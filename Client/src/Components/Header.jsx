  ...
  return (
    <Navbar className='border-b-2'>
        ...
        <Link to="/" className='self-center whitespace-normal text-sm sm:text-xl font-semibold dark:text-white'>
            <span className=' px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white'>Sky's</span>
            Blog
        </Link>
        <form action="">
        ...
        <Button className='w-12 h12 lg:hidden pill'>
          <AiOutlineSearch/>
        </Button>
